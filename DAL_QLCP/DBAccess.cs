...
namespace DAL_QLCP
{
    public class DBAccess
    {
        ...
        {
            connect = new SqlConnection(@"Data Source=.\SQLEXPRESS;Initial Catalog=QuanLyCaPhe;Integrated Security=True");
            try
            {
                connect.Open();
                connect.Close();
        ...
        public bool kiemTRaTonTai18(string maMon)
        {
            string query = "Select count (*) from tblDSMon where MaMon='" + maMon + "'";
            command = new SqlCommand(query, connect);
            int number = 0;
            try
            {
        ...
        public bool kiemTraTonTai19(string maLoaiMon)
        {
            string query = "Select count (*) from tblLoaiMon where MaLoaiMon='" + maLoaiMon + "'";
            command = new SqlCommand(query, connect);
            int number = 0;
            try
            {
        ...
        public string layMaMon(string maOrder)
        {
            SqlDataAdapter da = new SqlDataAdapter();
            string mamon = "";
            string query = "Select MaMon from tblCTOder where MaOder ='" + maOrder + "'";
            da.SelectCommand = new SqlCommand(query, connect);
            DataSet ds = new DataSet();
